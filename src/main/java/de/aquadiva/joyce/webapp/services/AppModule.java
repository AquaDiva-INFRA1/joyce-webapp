package de.aquadiva.joyce.webapp.services;
 ...
 */
@SubModule(JoyceEvaluationModule.class)
public class AppModule
{
    ...
    public static void bind(ServiceBinder binder)
    {
    	...
    	binder.bind(IBiOSSComparator.class, BiOSSComparator.class).withId("BiOSSComparator");;
    }
